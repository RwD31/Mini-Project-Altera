...
WebUI.click(findTestObject('Object Repository/Order/Page_frontend-web/span_1'))

WebUI.doubleClick(findTestObject('Object Repository/Order/Page_frontend-web/span_'))
