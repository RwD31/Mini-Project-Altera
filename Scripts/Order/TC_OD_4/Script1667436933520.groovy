...
WebUI.click(findTestObject('Object Repository/Order/Page_frontend-web/span_AltaShop_v-btn__content'))
...
WebUI.click(findTestObject('Object Repository/Order/Page_frontend-web/span_Login'))
...
WebUI.click(findTestObject('Object Repository/Order/Page_frontend-web/span_Bayar'))
