...
WebUI.setText(findTestObject('Login/Page_frontend-web/input_Email_input-1472'), 'Budi123@email.com')

WebUI.setText(findTestObject('Login/Page_frontend-web/input_Password_input-1475'), 'budi123')
